...
***
#### WoW, che bella novità direte voi!
Purtroppo no.<br>
...
Se in bitcoin vi è traccia di tutto quello che accade, in Lightning Network, scompare tutto una volta chiuso un canale[^2].<br>
Questa specifica caratteristica viene spesso utilizzata per rompere la tracciabilità di una transazione Bitcoin.<br>
...
*Gargamella* il curiosone, controllando la transazione in mempool vedrà i fondi di *Pippo* sparire senza sapere dove siano andati a finire mentre *Pippo* li ha già trasfertiti su un wallet non di passaggio, magari su un hardware wallet o un .
